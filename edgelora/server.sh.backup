...
case $MODEL in
    OpenELM-1.1B)
        ...
        ./llama-server -m ./models/OpenELM-1.1B/Q4_0-00001-of-00001.gguf -c 25600 --lora_repeated ./models/OpenELM-1.1B/lora.gguf $LORA_COUNT --adapter_cache_size $ADAPTER_CACHE --parallel 60 --batch_lora true --n-gpu-layers 999
        ;;
    Llama3.2-3B)
        # Set adapter_cache_size to LORA_COUNT if LORA_COUNT is smaller
        ...
        ./llama-server -m ./models/Llama3.2-3B/Llama-Sentient-3.2-3B-Instruct.Q4_0.gguf -c 8192 --lora_repeated ./models/Llama3.2-3B/Meta-Llama-3.2-3B-MEDAL-finetune-F16-LoRA.gguf $LORA_COUNT --adapter_cache_size $ADAPTER_CACHE --parallel 20 --batch_lora true --n-gpu-layers 999
        ;;
    Llama3.1-8B)
        # Set adapter_cache_size to LORA_COUNT if LORA_COUNT is smaller
